...
const isDrawn = /mac|darwin/i.test(navigator.userAgent)
...
// Legacy Vuex-based hotkey handling; replaced by direct Pinia store usage
export function ensureHotkeysMapExists() {
  // no-op: hotkeys map is managed by preferenceStore directly
}

export function handleEvent(_event, _callbackFnMap) {
  // no-op: replaced by direct keyboard event handling in components
}
