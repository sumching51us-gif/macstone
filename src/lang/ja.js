export default {
  common: {
    ...
    desc: 'AnyStone は、画像比較、ビデオ比較、画像カスタマイズ処理などの便利な機能をユーザーに提供するように設計されたクロスプラットフォームのネイティブアプリケーションです。',
    manual: 'マニュアル',
    hotKey: 'ホットキー',
    please: 'お願いします',
    reset: 'リセット',
  ...
  general: {
    ...
    aboutText: 'オン',
    introduction:
      'AnyStone は、画像比較、ビデオ比較、画像カスタマイズ処理などの便利な機能をユーザーに提供するように設計されたクロスプラットフォームのローカルアプリケーションです。',
    videoPlay: '動画の再生',
    videoCompare: '画像比較',
    compare: '比較',
    select: '選択する',
  ...
  sortFile: {
    ...
    generate: '生成',
    generateTip: 'クリックして、現在のディレクトリに.AnyStoneSort.iniソート構成ファイルを生成します',
    sortFile: 'ファイルを並べ替える',
