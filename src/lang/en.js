export default {
  common: {
    ...
    desc: 'AnyStone is a cross-platform native application designed to provide users with convenient functions such as picture comparison, video comparison.',
    manual: 'manual',
    hotKey: 'hotKey',
    please: 'please',
    reset: 'Reset',
  ...
  general: {
    ...
    aboutText: 'about',
    introduction:
      'AnyStone is a cross-platform local application designed to provide users with convenient functions such as local picture comparison, video comparison, and picture customization processing.',
  ...
  sortFile: {
    ...
    generate: 'Generate',
    generateTip: 'Click to generate the .AnyStoneSort.ini sorting configuration file in the current directory',
