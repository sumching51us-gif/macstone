export default {
  common: {
    ...
    desc: 'AnyStone 是一款跨平台的本地应用，旨在为用户提供本地图片对比、视频对比、图片定制处理等便捷功能。',
    manual: '使用手册',
    hotKey: '快捷键',
    please: '请',
    reset: '重置',
  ...
  general: {
    ...
    layout: '布局',
    aboutText: '关于',
    introduction: `AnyStone 是一款跨平台本地应用，旨在为用户提供本地图片比较，视频比较，图片定制化处理等便捷功能。`,
    videoPlay: '视频播放',
    videoCompare: '图片对比',
    compare: '对比',
    select: '选择',
  ...
  sortFile: {
    ...
    generate: '生成',
    generateTip: '点击即可在当前目录下生成.AnyStoneSort.ini排序配置文件',
    sortFile: '排序文件',
